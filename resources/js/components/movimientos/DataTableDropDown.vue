...
const destroy = (id: number) => {
    router.delete(movimientos.destroy(id).url, {
        onSuccess: () => {
...
const edit = () => {
    return router.visit(movimientos.edit(props.movimiento.id).url);
};
</script>
        ...
        <AlertDialogContent>
            <AlertDialogHeader>
                <AlertDialogTitle
                    ...
                    {{ movimiento.id }} ?</AlertDialogTitle
                >
                <AlertDialogDescription>
