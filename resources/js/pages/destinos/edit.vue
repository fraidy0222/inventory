...
import { Destino, type BreadcrumbItem } from '@/types';
import { Head, Link, useForm } from '@inertiajs/vue3';
import { toast } from 'vue-sonner';

const props = defineProps<{ destino: Destino }>();
...
const submit = () => {
    form.put(destinos.update(props.destino.id).url, {
        onSuccess: () => {
            toast.success('Destino editado exitosamente');
        },
    });
};
</script>
...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="container mx-auto px-4 py-10">
            <Card class="w-full">
                <CardHeader>
                    <CardTitle>Editar Destino</CardTitle>
                </CardHeader>
                <CardContent>
